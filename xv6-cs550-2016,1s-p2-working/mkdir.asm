...
main(int argc, char *argv[])
{
  ...
  47:	e8 40 04 00 00       	call   48c <mkdir>
  ...
  66:	c7 44 24 04 80 0a 00 	movl   $0xa80,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 62a:	0f b6 80 e0 0c 00 00 	movzbl 0xce0(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 78f:	75 27                	jne    7b8 <printf+0x11f>
          s = "(null)";
 791:	c7 45 f4 9c 0a 00 00 	movl   $0xa9c,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 85f:	a1 fc 0c 00 00       	mov    0xcfc,%eax
...
free(void *ap)
{
 ...
 92a:	a3 fc 0c 00 00       	mov    %eax,0xcfc
}
 92f:	c9                   	leave  
 930:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 97d:	e8 ce fe ff ff       	call   850 <free>
  return freep;
 982:	a1 fc 0c 00 00       	mov    0xcfc,%eax
}
 987:	c9                   	leave  
 988:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 99b:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 99e:	a1 fc 0c 00 00       	mov    0xcfc,%eax
 9a3:	89 45 f0             	mov    %eax,-0x10(%ebp)
 9a6:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 9aa:	75 23                	jne    9cf <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 9ac:	c7 45 f0 f4 0c 00 00 	movl   $0xcf4,-0x10(%ebp)
 9b3:	8b 45 f0             	mov    -0x10(%ebp),%eax
 9b6:	a3 fc 0c 00 00       	mov    %eax,0xcfc
 9bb:	a1 fc 0c 00 00       	mov    0xcfc,%eax
 9c0:	a3 f4 0c 00 00       	mov    %eax,0xcf4
    base.s.size = 0;
 9c5:	c7 05 f8 0c 00 00 00 	movl   $0x0,0xcf8
 9cc:	00 00 00 
  }
 ...
 a22:	a3 fc 0c 00 00       	mov    %eax,0xcfc
      return (void*)(p + 1);
 ...
 a2d:	eb 38                	jmp    a67 <malloc+0xde>
    ...
    if(p == freep)
 a2f:	a1 fc 0c 00 00       	mov    0xcfc,%eax
